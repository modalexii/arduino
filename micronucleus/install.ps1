...
IEX "$AVRDudeExe -C$AVRDudeConf -v -pattiny85 -carduino -P$COMPort -b19200 -e -U lfuse:w:0xF1:m -U hfuse:w:0xDD:m -U efuse:w:0xFE:m -Uflash:w:C:\Users\Kyle\Git\modalexii\arduino\micronucleus\t85_default.hex:i"
